...
本代码库包含我的知乎“体验更好地做软件”专栏中的系列文章“[万字长文]K8s部署前后端分离的web应用避坑系列指南之一：在本地开发环境、本地docker compose和k8s云集群里跑通购物清单应用（macOS-2023版）”的相关代码。
...
![图3 Shopping list web app在本地开发环境里的的context架构图](f-3.jpg)
